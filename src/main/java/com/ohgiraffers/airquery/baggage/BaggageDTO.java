package com.ohgiraffers.airquery.baggage;

import java.math.BigDecimal;

public class BaggageDTO {
    private int baggageCode; // 수하물 번호를 저장하는 값
    private int reservationCode; // 이 수하물이 어떤 예매와 연결되어 있는지 나타내느 예매 번호
    private BigDecimal baggageWeight; // 수하물 무게를 저장 하는 값
    ...
    // 수하물 무게가 소수점이 들어갈수 있으므로 BigDecimal 사용
    public BaggageDTO(int baggageCode, int reservationCode, BigDecimal baggageWeight) {
